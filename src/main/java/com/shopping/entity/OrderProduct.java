...
public class OrderProduct extends BaseEntity { // OrderProduct01, OrderProduct03
    ...
    @ManyToOne(fetch = FetchType.LAZY) // 한개의 상품은 여러개의 주문에 포함이 될 수 있습니다. // OrderProduct02
    @JoinColumn(name = "product_id")
    private Product product ;

    @ManyToOne(fetch = FetchType.LAZY) // 한건의 주문에는 여러 개의 상품들이 포함될 수 있습니다. // OrderProduct02
