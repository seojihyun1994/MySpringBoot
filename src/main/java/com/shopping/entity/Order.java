...
public class Order extends BaseEntity { // Order01, Order02
    @Id
...
//    private LocalDateTime updateDate ; // 수정 일자
    ...
    // Order07)
    public static Order createOrder(Member member, List<OrderProduct
            > orderProductList){
        Order order = new Order() ;
        order.setMember(member); // 주문자가 누구인지 작성
