...
public class MemberService implements UserDetailsService { // MemberService02
    ...
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException { // MemberService02
        ...
        return User.builder()
                ...
                .roles(member.getRole().toString()) // enum 타입이기 때문에 문자열로 만들어 주기위해 .toString() 써야함
                .build();
    }
}
